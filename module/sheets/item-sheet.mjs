...
export class SdmItemSheet extends api.HandlebarsApplicationMixin(
  ...
  static DEFAULT_OPTIONS = {
    classes: ['synthetic-dream-machine', 'item'],
    actions: {
  ...
  static PARTS = {
    header: {
      template: 'systems/synthetic-dream-machine/templates/item/header.hbs',
    },
    tabs: {
    ...
    description: {
      template: 'systems/synthetic-dream-machine/templates/item/description.hbs',
    },
    attributesFeature: {
      template:
        'systems/synthetic-dream-machine/templates/item/attribute-parts/feature.hbs',
    },
    attributesGear: {
      template: 'systems/synthetic-dream-machine/templates/item/attribute-parts/gear.hbs',
    },
    attributesSpell: {
      template: 'systems/synthetic-dream-machine/templates/item/attribute-parts/spell.hbs',
    },
    effects: {
      template: 'systems/synthetic-dream-machine/templates/item/effects.hbs',
    },
  };
